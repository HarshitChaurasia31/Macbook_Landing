...
import StudioLights from './3/StudioLights'
import {useMediaQuery} from 'react-responsive'
import ModelSwitcher from './3/ModelSwitcher'
  ...
  return (
    <section id='product-viewer'>
        ...
        <div className="controls">
            <p className='info'>Macbook Pro | Available in 14" & 16" in Space Gray & Deep Black</p>
